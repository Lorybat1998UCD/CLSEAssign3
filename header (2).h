...
struct human (struct players){ // HUMAN
		strcpy(player.classp, "Human");
...
struct ogre(struct players){// HUMAN
	strcpy(player.classp, "Ogre");
		//rand(time(NULL)); 
...
struct elf(struct players){		//ELF
	strcpy(player.classp, "Elf");
		//rand(time(NULL)); 
...
struct wizard(struct players){ 	//WIZARD

	strcpy(player.classp, "Wizard");
		//rand(time(NULL)); 
